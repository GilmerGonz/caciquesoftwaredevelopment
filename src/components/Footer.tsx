...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#0a0a0a] border-t border-[#1a1a1a] py-8 relative z-10">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-8 md:px-12 flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="flex flex-col">
          ...
          <span className="font-body text-[10px] text-[#555555] mt-1">
            Gilmer De Jesús González Álvarez · RIF V-28591956-4
          </span>
        </div>
